                ...
                <div className=' flex justify-center items-center flex-col'>
                    {
                        cart.length>0?(
                            <>
                                <Link id='orderButton' onClick={nextStepBar} to="/cart/user-information-section" className='w-[360px] h-[70px] text-[#FFF] text-[24px] bg-[#EE376B] border border-[#EE376B] flex justify-center items-center mb-[35px] mt-[14px]'>ĐẶT HÀNG NGAY</Link>
                            </>
                        ):(
                            <></>
                        )
