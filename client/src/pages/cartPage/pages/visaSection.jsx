        ...
        <div className="w-[800px] flex flex-col gap-5 mt-[50px]">
          ...
          <form className="w-[800px] flex flex-col shadow-xl border justify-center">
            ...
            <div className=" w-[750px] m-auto mb-[50px] flex justify-end">
                <Link id="addCard" to="/cart/check-bill-section" onClick={handleConfirmClick} className=" w-[180px] h-[45px] border bg-[#38D7E7] text-[#fff] flex justify-center items-center text-[24px]">XÁC NHẬN</Link>
            </div>
          </form>
