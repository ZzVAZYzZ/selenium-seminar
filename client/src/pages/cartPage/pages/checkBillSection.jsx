...
const prevStepBar = () => {
  ...
  return (
    <div className=" w-[800px] m-auto mb-[20px] flex flex-col items-center">
      ...
      <Link id="finishTransaction" to="/cart/finish-transaction" className='w-[360px] h-[70px] text-[#FFF] text-[20px] bg-[#EE376B] border border-[#EE376B] flex justify-center items-center mb-[15px] mt-[14px]' onClick={nextStepBar}>THANH TOÁN NGAY</Link>
