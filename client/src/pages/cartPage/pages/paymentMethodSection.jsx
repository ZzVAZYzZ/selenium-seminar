      ...
      <div className=' m-auto'>
            {
                paymentMethod==="COD"?
                    ...
                    : paymentMethod==="VISA"?
                    (
                        <Link to="/visa-section" id="thanhToanNgay" className='w-[360px] h-[70px] text-[#FFF] text-[20px] bg-[#EE376B] border border-[#EE376B] flex justify-center items-center mb-[35px] mt-[14px]'>THANH TOÁN NGAY</Link>
                    )
                    :
                    (
