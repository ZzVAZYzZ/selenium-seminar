    ...
    return (
        <>
            ...
            <div className=' m-auto'>
                <Link id='addPaymentMethod' to="/cart/payment-method-section" className='w-[360px] h-[70px] text-[#FFF] text-[20px] bg-[#EE376B] border border-[#EE376B] flex justify-center items-center mb-[35px] mt-[14px]' onClick={(e)=>handleCheckIsFill(e)}>THÊM PHƯƠNG THỨC THANH TOÁN</Link>
