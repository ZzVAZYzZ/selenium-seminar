    ...
    <div className=" w-[1167px] mx-auto flex flex-row justify-between mt-[120px]">
      ...
      <div className="w-[500px] h-[700px] shadow-lg flex flex-col justify-center items-center">
        ...
        <input
          ...
          onChange={(e)=>handleRegisterDataChange(e)}
        />
        <div id="changeToLoginForm" onClick={handleChangeFormClick} className="w-[450px] flex items-center gap-2 mt-[15px] cursor-pointer text-[#2C698D]">
            Already have a account?
        </div>
        <Link to="/login" className="mt-[20px]" onClick={handleSignupClick}>
          <button id="signupButton" className="w-[450px] h-[70px]  border text-[#fff] px-[30px] text-[32px] bg-[#2C698D] rounded-md">
            SIGN UP
          </button>
        </Link>
      </div>
    ...
    <div className=" w-[1167px] mx-auto flex flex-row justify-between mt-[120px]">
      ...
      <div className="w-[500px] h-[700px] shadow-lg flex flex-col justify-center items-center">
        ...
        <Link to="/login" className="mt-[20px]" >
          <button id="loginFormButton" onClick={handleLoginClick} className="w-[450px] h-[70px]  border text-[#fff] px-[30px] text-[32px] bg-[#2C698D] rounded-md">
            LOGIN
          </button>
        </Link>
        <Link
