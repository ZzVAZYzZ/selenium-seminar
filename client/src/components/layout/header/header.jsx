  ...
  return (
    <nav className=" w-full h-[100px] bg-[#38D7E7] flex flex-row justify-between">
      ...
      <div className="flex flex-row items-center gap-[50px] ">
        {userAccount.role === "" ? (
          <Link to="/login">
            <button id="loginButton" className="w-[150px] h-[50px] bg-white rounded-[8px] border border-[#2C698D] text-[#2C698D] text-[24px]">
              Login
            </button>
          </Link>
          ...
          <>
            <div id="userZone" className=" text-[24px] h-full text-[#fff]  hover:text-[#30494b] flex flex-row items-center gap-[10px] relative group ">
              ...
              <div className=" w-[350px] h-[320px] bg-[#DBFCFF] absolute top-[100px] left-[-175px] z-40 hidden group-hover:flex items-center flex-col">
                ...
                <div id="logout" className=" w-[250px] flex flex-row  gap-2 cursor-pointer mt-[5px] hover:bg-[#8bc3e4]" onClick={handleLogout}>
                  <div>
                    <svg
                      width="25"
                      height="25"
